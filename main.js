...
function setup(){
 ...
 var random_number = Math.floor(Math.random()*345);

 var sketch = quick_draw_data_set[random_number];
 document.getElementById("name_skecth").innerHTML = sketch;
 var timer_counter = 0;
 var timer_check = "";
 var draw_sketch = "";
 var answer_holder = "";
...
function check_sketch(){
    ...
    document.getElementById("time_num").innerHTML = timer_counter;
